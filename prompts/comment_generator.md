...
- Do not infer product details, scenes, tools, routines, plot points, or unverified experiences from a title alone.
...
- Avoid identifying data, false viewing claims, guaranteed outcomes, excessive advertising, and forced tag/share phrases.
